...
function navigateAndGenerate(section, generateFunction) {
    navigate(section);  // Navigate to the section
    setTimeout(generateFunction, 500);  // Delay function execution slightly for smooth transition
}
